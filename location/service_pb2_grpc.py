...
class LocationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLocation = channel.unary_unary(
                ...
                request_serializer=service__pb2.IpAddress.SerializeToString,
                response_deserializer=service__pb2.Point.FromString,
...
def add_LocationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetLocation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.IpAddress.FromString,
                    response_serializer=service__pb2.Point.SerializeToString,
            ),
    }
...
class Location(object):
    ...
    def GetLocation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/location.Location/GetLocation',
            service__pb2.IpAddress.SerializeToString,
            service__pb2.Point.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
